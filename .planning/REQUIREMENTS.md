...
- [x] **I18N-02**: All frontend form strings (labels, buttons, validation messages, success/error feedback) are wrapped in WordPress i18n functions and translatable
- [x] **I18N-03**: Plugin registers its text domain via `load_plugin_textdomain()` on init
- [x] **I18N-04**: A `.pot` source file is generated for the plugin (enables future community translations)
- [x] **I18N-05**: German (`de_DE`) `.po` and `.mo` translation files are provided covering all plugin strings
